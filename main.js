...
window.onload = function() {
    ...
    setInterval(function() {
        moveEverything();
        drawEverything();
    }, 1000 / framesPerSecond); // 1000 this is how many ms I want to wait between the function its gets called
...
function moveEverything() {
    ...
    computerMovement();
    ballX += ballSpeedX; // add to a value
    ballY += ballSpeedY; // add to a value
...
function drawEverything() {
    ...
    colorRect(canvas.width -
        PaddleThickness, paddle2Y,
